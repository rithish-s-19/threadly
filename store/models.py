...
class Order(models.Model):
    ...
    # Paytm fields
    paytm_order_id = models.CharField(max_length=100, blank=True, null=True, unique=True)
    paytm_transaction_id = models.CharField(max_length=100, blank=True, null=True)
